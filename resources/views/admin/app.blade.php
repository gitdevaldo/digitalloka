...
.tbl th{
  ...
  letter-spacing:0.09em;color:var(--muted-foreground);padding:9px 12px;
  border-bottom:2px solid var(--border);white-space:nowrap;
}
.tbl td{
  padding:11px 12px;font-size:0.8rem;font-weight:500;
...
<div class="page active" id="page-overview">
  ...
  <div class="stats-grid">
    ...
    <div class="stat-card"><div class="stat-icon" style="background:rgba(52,211,153,0.12)">✅</div><div class="stat-lbl">Active Entitlements</div><div class="stat-val">341</div><div class="stat-sub">12 expiring soon</div></div>
    <div class="stat-card"><div class="stat-icon" style="background:rgba(244,114,182,0.12)">👥</div><div class="stat-lbl">Total Users</div><div class="stat-val">1,284</div><div class="stat-sub">7 blocked</div></div>
    <div class="stat-card"><div class="stat-icon" style="background:rgba(251,191,36,0.15)">🛒</div><div class="stat-lbl">Total Orders</div><div class="stat-val">2,091</div><div class="stat-sub">3 pending</div></div>
    <div class="stat-card"><div class="stat-icon" style="background:rgba(139,92,246,0.1)">🖥️</div><div class="stat-lbl">Managed Droplets</div><div class="stat-val">47</div><div class="stat-sub">3 in action</div></div>
    <div class="stat-card"><div class="stat-icon" style="background:rgba(244,114,182,0.12)">⚡</div><div class="stat-lbl">Actions In Progress</div><div class="stat-val">3</div><div class="stat-sub">across 2 users</div></div>
    <div class="stat-card"><div class="stat-icon" style="background:rgba(52,211,153,0.12)">💰</div><div class="stat-lbl">Revenue (MTD)</div><div class="stat-val">$8.4k</div><div class="stat-sub">+12% vs last mo</div></div>
    <div class="stat-card"><div class="stat-icon" style="background:rgba(251,191,36,0.15)">📊</div><div class="stat-lbl">Audit Events (24h)</div><div class="stat-val">128</div><div class="stat-sub">2 failures</div></div>
  </div>
      ...
      <div class="panel-body">
        <div class="queue-card" style="background:rgba(244,114,182,0.08);">
          ...
          <div style="display:flex;align-items:center;gap:10px">
            <span style="font-family:var(--font-h);font-size:1.5rem;font-weight:900;color:var(--secondary)">3</span>
        ...
        <div class="queue-card" style="background:rgba(251,191,36,0.08);">
          ...
          <div style="display:flex;align-items:center;gap:10px">
            <span style="font-family:var(--font-h);font-size:1.5rem;font-weight:900;color:var(--tertiary)">12</span>
        ...
        <div class="queue-card" style="background:rgba(139,92,246,0.07);">
          ...
          <div style="display:flex;align-items:center;gap:10px">
            <span style="font-family:var(--font-h);font-size:1.5rem;font-weight:900;color:var(--accent)">3</span>
...
<div class="page" id="page-settings">
  <div class="ph">
    ...
    <div class="ph-actions">
      <button class="btn btn-accent" onclick="showToast('✅ Settings saved and audit logged.','ok')">Save All Changes</button>
    </div>
  </div>
  <div class="grid-2">
    <div>
      <div class="panel">
        ...
        <div class="panel-body">
          <div class="setting-row"><div><div class="setting-key">Default Product Visibility</div><div class="setting-desc">New products created as draft or published</div></div><select class="setting-select"><option>draft</option><option>published</option></select></div>
          <div class="setting-row"><div><div class="setting-key">Product Slug Format</div><div class="setting-desc">Auto-generated slug style</div></div><input class="setting-input" value="kebab-case" style="width:130px"/></div>
          <div class="setting-row"><div><div class="setting-key">Max Product Images</div><div class="setting-desc">Per product listing</div></div><input class="setting-input" type="number" value="8" style="width:70px"/></div>
          <div class="setting-row"><div><div class="setting-key">Reviews Enabled</div><div class="setting-desc">Allow users to leave product reviews</div></div><label class="toggle"><input type="checkbox" checked/><span class="toggle-slider"></span></label></div>
        </div>
      </div>
      <div class="panel">
        <div class="panel-hd"><div class="panel-title">🔑 Entitlement Defaults</div></div>
        <div class="panel-body">
          <div class="setting-row"><div><div class="setting-key">Default Expiry (days)</div><div class="setting-desc">Applied when no custom expiry is set</div></div><input class="setting-input" type="number" value="365" style="width:70px"/></div>
          <div class="setting-row"><div><div class="setting-key">Expiry Warning (days before)</div><div class="setting-desc">Notify user N days before expiry</div></div><input class="setting-input" type="number" value="7" style="width:70px"/></div>
          <div class="setting-row"><div><div class="setting-key">Auto-suspend on Expiry</div><div class="setting-desc">Automatically suspend expired entitlements</div></div><label class="toggle"><input type="checkbox" checked/><span class="toggle-slider"></span></label></div>
          <div class="setting-row"><div><div class="setting-key">Grace Period (days)</div><div class="setting-desc">Days after expiry before full revocation</div></div><input class="setting-input" type="number" value="3" style="width:70px"/></div>
        </div>
      </div>
    </div>
    <div>
      <div class="panel">
        ...
        <div class="panel-body">
          <div class="setting-row"><div><div class="setting-key">Auto-fulfill Digital Orders</div><div class="setting-desc">Grant access immediately after payment</div></div><label class="toggle"><input type="checkbox" checked/><span class="toggle-slider"></span></label></div>
          <div class="setting-row"><div><div class="setting-key">Currency</div><div class="setting-desc">Default storefront currency</div></div><select class="setting-select"><option>USD</option><option>IDR</option><option>EUR</option></select></div>
          <div class="setting-row"><div><div class="setting-key">Refund Window (days)</div><div class="setting-desc">Days a customer can request a refund</div></div><input class="setting-input" type="number" value="14" style="width:70px"/></div>
          <div class="setting-row"><div><div class="setting-key">Order ID Prefix</div><div class="setting-desc">Prefix for all generated order IDs</div></div><input class="setting-input" value="ORD-" style="width:90px"/></div>
        </div>
      </div>
      <div class="panel">
        <div class="panel-hd"><div class="panel-title">📧 Operational Contacts</div></div>
        <div class="panel-body">
          <div class="setting-row"><div><div class="setting-key">Billing Email</div><div class="setting-desc">Receives billing alerts and invoices</div></div><input class="setting-input" value="billing@digitalloka.dev" style="width:200px"/></div>
          <div class="setting-row"><div><div class="setting-key">Ops Alert Email</div><div class="setting-desc">Receives droplet and critical alerts</div></div><input class="setting-input" value="ops@digitalloka.dev" style="width:200px"/></div>
          <div class="setting-row"><div><div class="setting-key">Support Email</div><div class="setting-desc">User-facing support contact address</div></div><input class="setting-input" value="support@digitalloka.dev" style="width:200px"/></div>
          <div class="setting-row"><div><div class="setting-key">Audit Webhooks</div><div class="setting-desc">POST critical events to external endpoint</div></div><label class="toggle"><input type="checkbox"/><span class="toggle-slider"></span></label></div>
        </div>
      </div>
    </div>
  </div>
...
<div class="page" id="page-support">
  <div class="ph"><div><div class="ph-title">Support</div><div class="ph-sub">Internal support tools and documentation</div></div><div class="ph-actions"><button class="btn btn-accent">+ New Ticket</button></div></div>
  <div class="grid-3">
    <div class="panel" style="cursor:pointer" onclick="showToast('Opening docs…','ok')">
...
let DATA = {
  products:[
    {id:'PRD-001',name:'NovaDash UI Kit',slug:'novadash-ui-kit',type:'digital',cat:'UI Kit',visible:true,price:'$49',updated:'Mar 20'},
    {id:'PRD-002',name:'koncoweb VPS SGP1',slug:'vps-sgp1-2vcpu',type:'vps_droplet',cat:'VPS',visible:true,price:'$24/mo',updated:'Apr 1'},
    {id:'PRD-003',name:'AI Prompt Course',slug:'ai-prompt-course',type:'course',cat:'Education',visible:true,price:'$99',updated:'Mar 28'},
    {id:'PRD-004',name:'Indie Notion Pack',slug:'indie-notion-pack',type:'template',cat:'Productivity',visible:true,price:'$15',updated:'Feb 10'},
    {id:'PRD-005',name:'DataViz Pro Kit',slug:'dataviz-pro-kit',type:'digital',cat:'UI Kit',visible:false,price:'$69',updated:'Jan 30'},
    {id:'PRD-006',name:'SaaSify Landing Kit',slug:'saasify-landing',type:'template',cat:'Template',visible:true,price:'$39',updated:'Mar 15'},
  ],
  orders:[
    {id:'ORD-0042',user:'aldo@dl.dev',items:1,total:'$49',pay:'paid',fulfill:'active',created:'Feb 14'},
    {id:'ORD-0041',user:'aldo@dl.dev',items:1,total:'$24',pay:'paid',fulfill:'running',created:'Mar 1'},
    {id:'ORD-0040',user:'aldo@dl.dev',items:1,total:'$99',pay:'paid',fulfill:'pending',created:'Apr 1'},
    {id:'ORD-0039',user:'budi@test.com',items:2,total:'$88',pay:'paid',fulfill:'active',created:'Mar 22'},
    {id:'ORD-0038',user:'sari@demo.com',items:1,total:'$15',pay:'paid',fulfill:'active',created:'Dec 5'},
    {id:'ORD-0037',user:'rudi@corp.id',items:1,total:'$99',pay:'pending',fulfill:'pending',created:'Apr 2'},
  ],
  users:[
    {id:'USR-001',email:'aldo@dl.dev',role:'admin',status:'active',prods:5,last:'1h ago'},
    {id:'USR-002',email:'budi@test.com',role:'user',status:'active',prods:2,last:'3h ago'},
    {id:'USR-003',email:'sari@demo.com',role:'user',status:'active',prods:1,last:'2d ago'},
    {id:'USR-004',email:'rudi@corp.id',role:'user',status:'active',prods:0,last:'Just now'},
    {id:'USR-005',email:'spam@bad.io',role:'user',status:'blocked',prods:0,last:'1w ago'},
    {id:'USR-006',email:'dewi@startup.id',role:'user',status:'pending',prods:0,last:'Never'},
  ],
  entitlements:[
    {id:'ENT-001',user:'aldo@dl.dev',prod:'NovaDash UI Kit',order:'ORD-0042',status:'active',starts:'Feb 14',expires:'Feb 2027'},
    {id:'ENT-002',user:'aldo@dl.dev',prod:'VPS SGP1',order:'ORD-0041',status:'active',starts:'Mar 1',expires:'Apr 2027'},
    {id:'ENT-003',user:'aldo@dl.dev',prod:'DataViz Pro Kit',order:'ORD-0039',status:'expiring',starts:'Jan 10',expires:'Apr 9'},
    {id:'ENT-004',user:'budi@test.com',prod:'NovaDash UI Kit',order:'ORD-0039',status:'active',starts:'Mar 22',expires:'Mar 2027'},
    {id:'ENT-005',user:'sari@demo.com',prod:'Indie Notion Pack',order:'ORD-0038',status:'active',starts:'Dec 5',expires:'Dec 2026'},
    {id:'ENT-006',user:'spam@bad.io',prod:'SaaSify Kit',order:'ORD-0035',status:'revoked',starts:'Jan 1',expires:'—'},
  ],
  droplets:[
    {id:'DO-11223',user:'aldo@dl.dev',ent:'ENT-002',region:'SGP1',plan:'2vCPU/4GB',status:'running',ip:'192.168.1.10',last:'2h ago'},
    {id:'DO-11224',user:'aldo@dl.dev',ent:'ENT-002',region:'SGP1',plan:'1vCPU/2GB',status:'running',ip:'192.168.1.11',last:'5h ago'},
    {id:'DO-11225',user:'aldo@dl.dev',ent:'ENT-002',region:'SGP1',plan:'1vCPU/1GB',status:'stopped',ip:'—',last:'2d ago'},
    {id:'DO-11300',user:'budi@test.com',ent:'ENT-004',region:'NYC1',plan:'1vCPU/1GB',status:'running',ip:'10.0.0.5',last:'1h ago'},
    {id:'DO-11301',user:'dewi@startup.id',ent:'ENT-007',region:'FRA1',plan:'2vCPU/4GB',status:'starting',ip:'—',last:'5m ago'},
  ],
  audit:[
    {id:'EVT-0128',actor:'admin@dl.dev',action:'droplet.power_off',ttype:'droplet',tid:'DO-11225',result:'fail',ts:'2m ago',payload:{droplet_id:'DO-11225',reason:'timeout_after_30s',retried:false}},
    {id:'EVT-0127',actor:'admin@dl.dev',action:'entitlement.revoke',ttype:'entitlement',tid:'ENT-006',result:'ok',ts:'11m ago',payload:{entitlement_id:'ENT-006',user:'spam@bad.io',reason:'abuse_detected'}},
    {id:'EVT-0126',actor:'system',action:'entitlement.expire_warn',ttype:'entitlement',tid:'ENT-003',result:'warn',ts:'1h ago',payload:{entitlement_id:'ENT-003',expires_in_days:7}},
    {id:'EVT-0125',actor:'admin@dl.dev',action:'user.status_update',ttype:'user',tid:'USR-005',result:'ok',ts:'3h ago',payload:{user_id:'USR-005',old:'active',new:'blocked'}},
    {id:'EVT-0124',actor:'admin@dl.dev',action:'product.toggle_visibility',ttype:'product',tid:'PRD-005',result:'ok',ts:'4h ago',payload:{product_id:'PRD-005',is_visible:false}},
    {id:'EVT-0123',actor:'system',action:'order.auto_fulfill',ttype:'order',tid:'ORD-0042',result:'ok',ts:'6h ago',payload:{order_id:'ORD-0042',entitlement_created:'ENT-001'}},
    {id:'EVT-0122',actor:'admin@dl.dev',action:'droplet.reboot',ttype:'droplet',tid:'DO-11223',result:'ok',ts:'8h ago',payload:{droplet_id:'DO-11223',requested_by:'admin@dl.dev'}},
    {id:'EVT-0121',actor:'admin@dl.dev',action:'settings.update',ttype:'settings',tid:'catalog.default_visibility',result:'ok',ts:'1d ago',payload:{key:'default_visibility',old:'published',new:'draft'}},
  ]
};
...
function renderProducts(){
  document.getElementById('products-body').innerHTML = DATA.products.map(p=>`<tr>
    ...
    <td><div class="act-group">
      <button class="btn btn-sm" onclick="showToast('✏️ Edit product — connect backend.','ok')">Edit</button>
      <button class="btn btn-sm btn-ghost" onclick="showToast('👁️ Visibility toggled.','ok')">${p.visible?'Hide':'Show'}</button>
      <button class="btn btn-sm btn-ghost" onclick="showToast('🏷️ Manage tags.','ok')">Tags</button>
    </div></td>
  </tr>`).join('');
}
...
function renderOrders(){
  document.getElementById('orders-body').innerHTML = DATA.orders.map(o=>`<tr>
    ...
    <td><div class="act-group">
      <button class="btn btn-sm" onclick="showToast('📦 View order details.','ok')">View</button>
      <button class="btn btn-sm btn-ghost" onclick="showToast('✅ Status updated.','ok')">Update</button>
    </div></td>
  </tr>`).join('');
}
...
function renderUsers(){
  document.getElementById('users-body').innerHTML = DATA.users.map(u=>`<tr>
    ...
    <td><div class="act-group">
      <button class="btn btn-sm" onclick="showToast('👤 View user detail.','ok')">View</button>
      <button class="btn btn-sm ${u.status==='blocked'?'btn-success':'btn-danger'}" onclick="showToast('${u.status==='blocked'?'✅ User unblocked.':'🚫 User blocked.'}','ok')">${u.status==='blocked'?'Unblock':'Block'}</button>
    </div></td>
  </tr>`).join('');
}
...
function renderEntitlements(){
  document.getElementById('ent-body').innerHTML = DATA.entitlements.map(e=>`<tr>
    ...
    <td><div class="act-group">
      <button class="btn btn-sm btn-success" onclick="showToast('✅ Entitlement activated.','ok')">Activate</button>
      <button class="btn btn-sm btn-warn" onclick="showToast('⏸ Entitlement suspended.','ok')">Suspend</button>
      <button class="btn btn-sm btn-danger" onclick="showToast('🚫 Entitlement revoked.','ok')">Revoke</button>
      <button class="btn btn-sm" onclick="showToast('📅 Extended by 30 days.','ok')">+30d</button>
    </div></td>
  </tr>`).join('');
}
...
function renderDroplets(){
  document.getElementById('droplets-body').innerHTML = DATA.droplets.map(d=>`<tr id="dr-${d.id.replace('-','_')}">
    ...
    <td><div class="act-group">
      ...
      <button class="btn btn-sm btn-ghost" onclick="showToast('📋 Action log for ${d.id}.','ok')">Log</button>
    </div></td>
  </tr>`).join('');
}

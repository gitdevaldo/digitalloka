...
Route::get('/login', [AuthPageController::class, 'userLogin']);
Route::get('/admin/login', [AuthPageController::class, 'adminLogin']);
...
Route::middleware('supabase.admin')->group(function (): void {
	...
	Route::get('/admin/droplets', [AdminPageController::class, 'droplets']);
	Route::get('/admin/audit-logs', [AdminPageController::class, 'auditLogs']);
	Route::get('/admin/settings', [AdminPageController::class, 'settings']);
	Route::get('/admin/account', [AdminPageController::class, 'account']);
	Route::get('/admin/support', [AdminPageController::class, 'support']);
});

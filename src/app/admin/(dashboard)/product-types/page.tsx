    ...
    },
    {
      ...
      render: (row: Record<string, unknown>) => (
        <div className="flex gap-1 flex-wrap">
          <Button size="sm" onClick={() => router.push(`/admin/product-types/${encodeURIComponent(row.type as string)}/edit`)}>Edit</Button>
      ...
      <PageHeader
        ...
        actions={
          <div className="flex gap-2">
            ...
            <Button variant="accent" onClick={() => router.push('/admin/product-types/create')}>+ Create Type</Button>
          </div>
        }
      />

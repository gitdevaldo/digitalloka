...
@elseif ($variant === 'catalog')
    <header class="topbar">
        ...
        <div class="topbar-right">
            <x-ui.button id="wishlistButton" variant="ghost" as="a" href="#">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/>
                </svg>
                <span class="tb-label">Wishlist</span>
                <span id="tb-wishlist-count" class="tb-wishlist-count">(0)</span>
            </x-ui.button>
            <x-ui.button id="cartButton" variant="accent" as="a" href="#">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 0 1-8 0"/>
                </svg>
                <span class="tb-label">Cart</span>
                <span class="tb-cart-count">(0)</span>
            </x-ui.button>
        </div>
    </header>
@endif
